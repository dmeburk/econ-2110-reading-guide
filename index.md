...
Use this guide alongside the course calendar to see which sections are relevant for a given week.
...
- **Definition 1.1-1 (Probability)**  
  ...
  - You may be more familiar with a long-run frequency definition, where  
    \[
